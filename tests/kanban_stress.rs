...
fn create_100_items_in_one_project() {
    ...
    for i in 1..=100 {
        ...
        let item = store
            .create_item(&title, "bigproject", "work", None, None, None, None, None, None, None, None, None, &pf)
            .unwrap();
...
fn create_items_across_20_projects() {
    ...
    for p in &projects {
        store
            .create_item(&format!("Task for {p}"), p, "work", None, None, None, None, None, None, None, None, None, &pf)
            .unwrap();
    }
...
fn create_with_empty_title() {
    ...
    let item = store
        .create_item("", "proj", "work", None, None, None, None, None, None, None, None, None, &pf)
        .unwrap();
...
fn create_with_unicode_title() {
    ...
    let pf = HashMap::new();
    let item = store
        .create_item("修复计费流程 🔥", "proj", "work", None, None, None, None, None, None, None, None, None, &pf)
        .unwrap();
...
fn create_with_very_long_title() {
    ...
    let item = store
        .create_item(&long_title, "proj", "work", None, None, None, None, None, None, None, None, None, &pf)
        .unwrap();
...
fn create_with_sql_injection_in_title() {
    ...
    let item = store
        .create_item(
            ...
            "proj",
            "work",
            None, None, None, None, None, None, None, None, None, &pf,
        )
        .unwrap();
...
fn create_with_invalid_status() {
    ...
    let result = store.create_item(
        "Task", "proj", "work", None, Some("invalid_status"), None, None, None, None, None, None, None, &pf,
    );
...
fn create_with_invalid_priority() {
    ...
    let pf = HashMap::new();
    let result = store.create_item(
        "Task", "proj", "work", None, None, Some("critical"), None, None, None, None, None, None, &pf,
    );
    assert!(result.is_err());
...
fn move_through_all_statuses() {
    ...
    let pf = HashMap::new();
    store
        .create_item("Task", "proj", "work", None, Some("backlog"), None, None, None, None, None, None, None, &pf)
        .unwrap();
...
fn move_to_same_status() {
    ...
    let pf = HashMap::new();
    store
        .create_item("Task", "proj", "work", None, Some("todo"), None, None, None, None, None, None, None, &pf)
        .unwrap();
...
fn move_to_invalid_status() {
    ...
    let pf = HashMap::new();
    store
        .create_item("Task", "proj", "work", None, None, None, None, None, None, None, None, None, &pf)
        .unwrap();
...
fn query_with_custom_query() {
    ...
    let pf = HashMap::new();
    store
        .create_item("Urgent", "proj", "work", None, Some("todo"), Some("urgent"), None, None, None, None, None, None, &pf)
        .unwrap();
    store
        .create_item("Low", "proj", "work", None, Some("todo"), Some("low"), None, None, None, None, None, None, &pf)
        .unwrap();
...
fn list_with_all_filters() {
    ...
    store.create_item("Match", "proj", "work", None, Some("todo"), Some("high"), Some("jack"), None, None, None, None, None, &pf).unwrap();
    store.create_item("Wrong status", "proj", "work", None, Some("backlog"), Some("high"), Some("jack"), None, None, None, None, None, &pf).unwrap();
    store.create_item("Wrong priority", "proj", "work", None, Some("todo"), Some("low"), Some("jack"), None, None, None, None, None, &pf).unwrap();
    store.create_item("Wrong assignee", "proj", "work", None, Some("todo"), Some("high"), Some("alice"), None, None, None, None, None, &pf).unwrap();
    store.create_item("Wrong project", "other", "work", None, Some("todo"), Some("high"), Some("jack"), None, None, None, None, None, &pf).unwrap();
...
fn list_ordering_priority_then_recency() {
    ...
    store.create_item("Low", "proj", "work", None, None, Some("low"), None, None, None, None, None, None, &pf).unwrap();
    store.create_item("Urgent", "proj", "work", None, None, Some("urgent"), None, None, None, None, None, None, &pf).unwrap();
    store.create_item("High", "proj", "work", None, None, Some("high"), None, None, None, None, None, None, &pf).unwrap();
...
fn prefix_derivation_with_numbers() {
    ...
    let pf = HashMap::new();
    store
        .create_item("Task", "v2app", "work", None, None, None, None, None, None, None, None, None, &pf)
        .unwrap();
...
fn prefix_with_config_override() {
    ...
    store
        .create_item("Task", "myproj", "work", None, None, None, None, None, None, None, None, None, &pf)
        .unwrap();
...
fn rapid_create_move_note_cycle() {
    ...
    for i in 1..=20 {
        ...
        let item = store
            .create_item(&title, "proj", "work", None, None, None, None, None, None, None, None, None, &pf)
            .unwrap();
...
fn list_with_domain_filter() {
    ...
    store.create_item("Work task", "proj", "work", None, None, None, None, None, None, None, None, None, &pf).unwrap();
    store.create_item("Personal task", "hobby", "personal", None, None, None, None, None, None, None, None, None, &pf).unwrap();
